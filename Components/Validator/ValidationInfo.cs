      ...
      private void SetError(ValidationType errorType)
      {
        ...
        switch (errorType)
        {
          ...
          case ValidationType.Required:
            message =!string.IsNullOrEmpty(this.RequiredMessage) ? this.requiredMessage : Resources.VALIDATOR_DEFAULT_REQUIREMESSAGE;
            break;
          case ValidationType.RegularExpression:
            message =!string.IsNullOrEmpty(this.regularExpressionMessage)
              ? this.regularExpressionMessage
              : Resources.VALIDATOR_DEFAULT_REGULAREXPRESSIONMESSAGE;
            break;
          ...
          case ValidationType.Custom:
            message =!string.IsNullOrEmpty(this.customMessage) ? this.customMessage : Resources.VALIDATOR_DEFAULT_CUSTOMMESSAGE;
            break;
          default:
            message = null;
            break;
